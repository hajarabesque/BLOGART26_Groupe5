...
if(isset($_GET['numMotCle'])){
    ...
    $libStat = sql_select("MOTCLE", "libMotCle", "numMotCle = $numMotCle")[0]['libMotCle'];
}
?>
        ...
        <div class="col-md-12">
            ...
            <form action="<?php echo ROOT_URL . '/api/keywords/delete.php' ?>" method="post">
                <div class="form-group">
                    ...
                    <input id="libMotCle" name="libMotCle" class="form-control" type="text" value="<?php echo($libStat); ?>" readonly="readonly" disabled />
                </div>
                <br />
