<?php
// 1. Logique et Connexion
error_reporting(E_ALL & ~E_NOTICE & ~E_WARNING);

if (!defined('SQL_HOST')) define('SQL_HOST', '127.0.0.1;port=8889');
if (!defined('SQL_USER')) define('SQL_USER', 'root');
if (!defined('SQL_PWD')) define('SQL_PWD', 'root');
if (!defined('SQL_DB')) define('SQL_DB', 'BLOGART26');
...
// 3. Récupération des articles (Note : Correction des noms de colonnes dans la requête si besoin, mais SELECT * suffit)
...
<main id="page-top">
    ...
    <img src="../../src/uploads/<?= htmlspecialchars($art['urlPhotArt']); ?>" alt="Photo de l'article" class="img-fluid">                                </div>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p class="text-muted italic">Pas d'autres actualités pour le moment.</p>
                    <?php endif; ?>
                </div>
